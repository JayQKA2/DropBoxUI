...
import vn.edu.usth.dropboxui.ui.Adapter.MusicAdapter;
...
public class MusicFragment extends Fragment {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            if (data != null) {
                                ...
                                uploadFileToDropbox(selectedAudioUri, "Bearer " + accessToken , "/my_folder/selected_file");
                            }
                        }
                    }
                }
    ...
    private void fetchMusic() {
        ...
        StringRequest fileRequest = new StringRequest(
                ...
                API_URL,
                response -> {
                    Log.d(TAG, "fetchMusic: response received");
                    try {
